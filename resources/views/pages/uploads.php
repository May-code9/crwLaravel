...
<head>
	...
	<link rel="stylesheet" href="v5/css/components/bs-filestyle.css" type="text/css" />
...
<body class="stretched">
				...
				<div class="container clearfix">
					...
					<div class="postcontent nobottommargin clearfix">
						...
						<div class="row">
							...
							<div class="col-lg-6 bottommargin">
								<label>Hide The Preview Thumbnail:</label><br>
								<input id="input-2" type="file" class="file" data-show-preview="false">
							</div>
							...
							<div class="col-lg-6 bottommargin">
								<label>Disabled File Input:</label><br>
								<input id="input-4" type="file" class="file" disabled="true">
							</div>

							<div class="col-lg-6 bottommargin">
								<label>Disabled Caption:</label><br>
								<input id="input-5" name="input5[]" type="file" multiple class="file-loading">
							</div>

							<div class="col-lg-12 bottommargin">
								<label>Change size of whole widget:</label><br>
							...
							<div class="col-lg-6 bottommargin">
								<label>Custom Buttons:</label><br>
								<input id="input-8" type="file" accept="image/*" class="file-loading"data-allowed-file-extensions='[]'>

							</div>

							<div class="col-lg-6 bottommargin">
								<label>"txt" Files Preview Only:</label><br>
								<input id="input-9" name="input9[]" type="file" class="file-loading" accept="text/plain" multiple>

							</div>

							<div class="col-lg-6 bottommargin">
								<label>Left Button Style:</label><br>
								<input id="input-10" name="input10[]" type="file" multiple class="file-loading">
							</div>
							...
							<div class="col-lg-6">
								<label>Disable preview and customize own error container and messages:</label><br>
	...
	============================================= -->
	<script src="v5/js/jquery.js"></script>
	<script src="v5/js/plugins.js"></script>

	<!-- Bootstrap File Upload Plugin -->
	<script src="v5/js/components/bs-filestyle.js"></script>

	<!-- Footer Scripts
	============================================= -->
	<script src="v5/js/functions.js"></script>
